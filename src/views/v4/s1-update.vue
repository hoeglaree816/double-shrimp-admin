<template>
  <div class="root">
    <div class="title">
      ...
      <h2>修改<span>-</span>商品Id为：<span>{{ id }}</span> 的详细信息</h2>
    </div>
    <main>
      ...
      <el-row>
        <el-col :span="2">
          <el-button type="primary" @click="add">缺定</el-button>
        </el-col>
      </el-row>-->
      <el-row>
        <el-col :span="16">
          <el-form ref="data" :model="data" label-width="150px" :rules="rules">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item :label="label.productStars" prop="productStars">
                  <el-input v-model="data['productStars']" placeholder="0" disabled></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item :label="label.productCreated" prop="productCreated">
                  <el-input v-model="data['productCreated']" placeholder="无" disabled></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item :label="label.productUpdated" prop="productUpdated">
                  <el-input v-model="data['productUpdated']" placeholder="无" disabled></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <!-- 商品图片和商铺id放在一行 -->
