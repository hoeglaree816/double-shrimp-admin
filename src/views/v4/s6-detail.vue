<template>
  <div class="root">
    <div class="title">
      ...
      <h2>商品评论id为：<span>{{ id }}</span> 的详细信息</h2>
    </div>
    <main>
      <el-row
        class="txt-row"
      ...
      >
        ...
        <el-col
          ...
          :span="20"
        >
          <el-image :src="data[0][name]">
          </el-image>
        </el-col>
        <el-col v-else-if="value == '评论状态'" class="txt-value" :span="20">
          <el-tag size="medium" v-if="data[0][name] == 1" type="warning">待审核</el-tag>
          <el-tag size="medium" v-else-if="data[0][name] == 2" type="success">已审核可见</el-tag>
