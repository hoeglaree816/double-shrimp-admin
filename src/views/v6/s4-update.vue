<template>
  <div class="root">
    <div class="title">
      ...
      <h2>修改<span>-</span>管理员id为：<span>{{ id }}</span> 的详细信息</h2>
    </div>
    <main>
      <!-- <el-row>
        <el-col :span="16">
          <el-form ref="data" :model="data" label-width="150px" :rules="rules">
            ...
            >
              ...
              <el-select v-else-if="value == '基地身份'" v-model="data[name]" placeholder="请选择" style="width:125px;">
                <el-option
...
export default {//有一个警告
  ...
  methods: {
    add() {
      ...
      model.update(tempdata).then((value) => {
        //提示用户操作情况
        if (value.data.flag) {
            this.$message({
              type: "success",
