<template>
  <div id="retrievePassword">
    <el-menu mode="horizontal" background-color="#003366" text-color="#fff">
      <el-menu-item index="1" @click="returnLogin">返回登录</el-menu-item>
    </el-menu>
    <el-row>
      <el-col :span="7">
