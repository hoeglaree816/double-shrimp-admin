          ...
          <el-col :span="24">
            <div class="form">
              ...
              <div class="right">
                ...
                <el-row>
                  <el-col :span="13">
                    <el-form-item :label="label.id" prop="id">
                      <el-input v-model.number="ruleForm.id" placeholder="请输入内容" disabled></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="11">
                ...
                <!-- <el-form-item> -->
                <el-button  type="success" @click="submitForm('ruleForm')">确定更新</el-button>
