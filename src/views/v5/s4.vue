  ...
  <div class="root">
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="name" label="专家分类" width="680" align="center"></el-table-column>
        <el-table-column prop="parentId" label="父级类型" width="525"></el-table-column>
...
export default {
  data() {
    return {
      ...
      expertConsultation_type_delete:true,//专家类别删除
      expertConsultation_type_select:true,//专家类别查询
    };
  },
  methods: {
    handleAdd() {
      this.$router.push("/v5/s4-insert");
    },
