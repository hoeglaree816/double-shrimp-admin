      ...
      <el-col :span="14" class="form-col">
        ...
        <el-card class="box-card" shadow="hover" body-style="border-top:1px solid #003366;">
          ...
          <div class="box-card-divII">
            <p>欢迎进入 <span>专家问诊</span> 模块，您拥有下面展示的权限！！！</p>
          </div>
...
export default {
  ...
  mounted(){
    new Promise((resolve) => {
      ...
      axios({
        method: "get",
        // url: "http://106.75.154.40:9012/authority/admin/authority/" + 'expertConsultation',
        url: "http://106.75.154.40:9003/admin/authority/" + 'expertConsultation',
      }).then((res) => {
        resolve(res)
